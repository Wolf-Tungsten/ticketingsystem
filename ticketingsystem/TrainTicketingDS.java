...
class AdptGraLazyTrainTicketingDS extends TrainTicketingDS {

    AdptGraLazyTrainTicketingDS(int trainNr, int coachnum, int seatnum, int stationnum, int threadnum, boolean enableCache){
        super(trainNr, coachnum, seatnum, stationnum);
